...
- `dont-mcp-interface` is sourced from `dont-spec-v0_3_2.md` §16.

## Impact
- Affected specs: `dont-derived-queries`, `dont-agent-help`, `dont-spawn-protocol`, `dont-mcp-interface` (all new)
